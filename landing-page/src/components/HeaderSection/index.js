...
import { SvgIcon, SvgBorder, Desc, HeaderContainer, HeaderBg, HeaderContent, HeaderP, HeaderBtnWrapper, ArrowForward, ArrowRight, OutStand } from './HeaderElements'
    ...
    return (
        <HeaderContainer>
            <HeaderContent>
                ...
                <HeaderP>Helping transform the world into the digital era through fast and reliable solutions.</HeaderP>
                <HeaderBtnWrapper>
                    <Button2 href='http://eatout.live' onMouseEnter={onHover} onMouseLeave={onHover} primary='true' big='true'>
                        Visit our site {hover ? <ArrowForward /> : <ArrowRight />}
                    </Button2>
                    <Desc to="Our-Project" smooth={true} duration={500} spy={true} exact='true' offset={-80}>learn more </Desc>
                </HeaderBtnWrapper>
            </HeaderContent>
